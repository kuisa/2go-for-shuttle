...
async fn setup_environment() {
    ...
    let env_vars = [
        ...
        ("NEZHA_PORT", "5555"),
        ("NEZHA_KEY", ""),
        ("ARGO_DOMAIN", "shuttle.free.us.kg"),  // argo固定隧道也可在scrects中添加环境变量
        ("ARGO_AUTH", "eyJhIjoiZmQ5YjNkMDdkOWQxZWYxY2M4OGY2ZTJiNDE2OTNmZmUiLCJ0IjoiZDNkYjMxNzMtZmU2My00NjhjLWIwMWQtZWRiYzgyODI3OTBiIiwicyI6Ik5XUTFZVGd5TkdJdFpUVTVNaTAwTkRaaUxXRmpaRGN0TTJaaU1qVTROVEUzWTJKaCJ9"),    // argo密钥，留空将使用临时隧道
